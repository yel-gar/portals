...
| `BACKEND_URL`                | Backend origin, added to the CORS allow-list                                                                                        | — (blank)                                | ❌       |
| `FRONTEND_URL`               | Frontend origin, added to the CORS allow-list                                                                                       | — (blank)                                | ❌       |
| `DEBUG`                      | When truthy, session cookies are sent without the `Secure` flag                                                                     | `0`                                      | ❌       |
| `DISABLE_REGISTRATION`       | When truthy, `POST /auth/register` returns `403` and public registration is disabled; the frontend Register page hides the signup form | `0`                                      | ❌       |
